                ...
                const cartsFromApi = res.data;
                 ...
                 cartsFromApi.forEach((cart)=>{
                    ...
                    if(cart.TRANG_THAI===0){
                        cart.TRANG_THAI = 'Chờ duyệt';
                    }
                    if(cart.TRANG_THAI===1){
                        cart.TRANG_THAI = 'Đã duyệt';
                    }
                    if(cart.TRANG_THAI===2){
                        cart.TRANG_THAI = 'Đang giao hàng';
                    }
                    if(cart.TRANG_THAI===3){
                        cart.TRANG_THAI = 'Đã hủy';
                    }
                 })
                 console.log(cartsFromApi);
        ...
        locale='vi-VN'
         ...
         >
            <ColumnsDirective>
                ...
                <ColumnDirective field='TRANG_THAI' headerTextAlign='Center' headerText='Trạng thái' width='200' textAlign="Left"/>
