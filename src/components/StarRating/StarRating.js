...
function StarRating(props) {
    ...
    return (
        <div className={clsx(style.ratingContainer, { [style.readOnly]: props.readOnly })}>
            <img src={val >= 1 ? star16 : starOutLine16} alt=""
                onMouseEnter={(e) => {
            ...
            <img src={val >= 2 ? star16 : starOutLine16} alt=""
                onMouseEnter={(e) => {
                    setVal(2);
                    setToggleOnMouseLeave(true);
                }}
            ...
            <img src={val >= 3 ? star16 : starOutLine16} alt=""
                onMouseEnter={(e) => {
                    setVal(3);
                    setToggleOnMouseLeave(true);
                }}
            ...
            <img src={val >= 4 ? star16 : starOutLine16} alt=""
                onMouseEnter={(e) => {
                    setVal(4);
                    setToggleOnMouseLeave(true);
                }}
            ...
            <img src={val >= 5 ? star16 : starOutLine16} alt=""
                onMouseEnter={(e) => {
                    setVal(5);
                    setToggleOnMouseLeave(true);
                }}
