...
navOpen.addEventListener("click", function () {
    console.log(1)
    if (document.querySelector('.submenu').hasClass("translateX-0")) {
        document.querySelector('.nav__item i').toggleClass("rotate--90deg");
        document.querySelector('.header__nav-list .nav__item:not(:first-child)').toggleClass("translateY-calc-52x5px");
        document.querySelector('.submenu').toggleClass("translateX-0");
        return;
    }
    document.querySelector('.nav__item i').toggleClass("rotate--90deg");
    document.querySelector('.header__nav-list .nav__item:not(:first-child)').toggleClass("translateY-calc-52x5px");
...
document.querySelector('.mobile-menu-button').click(function () {
    document.querySelector(this).toggleClass("active");
    if (mobileMenuisHidden) {
        document.querySelector(".header__nav-list").css({
            left: 0
        });
...
function closeMenu() {
    ...
    searchWrapper.style.backgroundColor = null;
    const s = setTimeout(function () { searchWrapper.style.width = "0"; }, 300);
    document.querySelector(".mobile-menu-button").toggleClass("active");
}
...
// function incrementValue(e) {
//     e.preventDefault();
//     var fieldName = document.querySelector(e.target).data('field');
//     var parent = document.querySelector(e.target).closest('div');
...
// document.querySelector('.input-group').on('click', '.button-plus', function (e) {
//     incrementValue(e);
// });

// document.querySelector('.input-group').on('click', '.button-minus', function (e) {
//     decrementValue(e);
// });
